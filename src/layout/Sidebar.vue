    ...
    <div class="sidebar h-screen transition-all duration-300 ease-in-out flex flex-col border-r border-border"
        ...
        <nav class="flex flex-col flex-grow overflow-y-auto px-2 py-3 gap-0.5">
            ...
            <router-link v-if="featureStore.isEnabled('relationships')" to="/relationships"
                ...
                <span v-if="!collapsed"
                    class="ml-3 text-sm font-medium group-hover:text-text-primary transition-colors">Relationships</span>
            </router-link>
            ...
            <router-link v-if="featureStore.isEnabled('bibliography')" to="/bibliography"
                ...
                <span v-if="!collapsed"
                    class="ml-3 text-sm font-medium group-hover:text-text-primary transition-colors">Bibliography</span>
            </router-link>
