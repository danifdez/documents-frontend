<template>
    <header class="topbar flex items-center gap-2 px-3 h-14 border-b border-border shrink-0"
        ...
        <nav class="flex items-center gap-0.5 flex-1 min-w-0 overflow-x-auto">
            <button @click="openBrowser" :title="'Browser'"
                class="group flex items-center gap-2 px-3 py-2 text-text-secondary rounded-lg hover:bg-surface-hover hover:text-text-primary transition-colors cursor-pointer whitespace-nowrap">
            ...
            <router-link v-if="featureStore.isEnabled('relationships')" to="/relationships"
                class="group flex items-center gap-2 px-3 py-2 text-text-secondary rounded-lg hover:bg-surface-hover hover:text-text-primary transition-colors whitespace-nowrap"
                active-class="!bg-accent-subtle !text-accent-dark font-medium">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-[18px] w-[18px] shrink-0" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="1.75">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <router-link v-if="featureStore.isEnabled('bibliography')" to="/bibliography"
                ...
                <span class="text-sm font-medium">Bibliography</span>
            </router-link>
